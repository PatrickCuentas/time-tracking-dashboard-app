...
const Weekly = () => {
  const cards = [
    ...
    {
      title: "Study",
      color: "bg-primary-light_red_study",
      icon: (
        <svg
          className="absolute right-8 opacity-30"
          width="79"
    ...
    },
    {
      ...
      icon: (
        <svg
          className="absolute -top-1 right-8 opacity-30"
          width="75"
          height="120"
          xmlns="http://www.w3.org/2000/svg"
        >
  ...
  return (
    <div className="grid place-content-center text-lg font-rubik bg-neutral-very_dark_blue">
      ...
      <Profile focus="weekly">
        <Card card={cards[0]} tiempo="weekly" />
        <Card card={cards[1]} tiempo="weekly" />
        <Card card={cards[2]} tiempo="weekly" />
        <Card card={cards[3]} tiempo="weekly" />
        <Card card={cards[4]} tiempo="weekly" />
        <Card card={cards[5]} tiempo="weekly" />
      </Profile>
